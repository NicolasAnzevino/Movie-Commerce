<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormVerVenta.aspx.cs" Inherits="Movie_Commerce.FormVerVenta" %>
      ...
      <ul class="nav nav-pills">
        ...
        <div class="container row">
            <div class="table small">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Movie-CommerceConnectionString %>" SelectCommand="SELECT 'Codigo de Pelicula' = Peli_Codigo, 'Pelicula' = Peli_Nombre, 'Precio' = Peli_Precio, 'Imagen' = Peli_Imagen FROM Pelicula JOIN Venta_Detalle on (VentaD_Peli_Codigo = Peli_Codigo AND VentaD_Venta_Codigo = @VID)">                    <SelectParameters>
