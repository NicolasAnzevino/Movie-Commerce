<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormVerProductos.aspx.cs" Inherits="Movie_Commerce.FormVerProductos" %>
...
<body>
    ...
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <ul class="nav nav-pills">
         ...
         <li class="nav-item">
              <asp:LinkButton ID="linklblVerProductos" runat="server" class="nav-link active" Visible="False" CommandName="Ver Productos" OnClick="linklblVerProductos_Click" >Ver Productos</asp:LinkButton>
          </li>
          <li class="nav-item">
