<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormMainMenu.aspx.cs" Inherits="Movie_Commerce.FormMainMenu" %>

<%@ Register src="PeliculaControl.ascx" tagname="PeliculaControl" tagprefix="uc1" %>
<%@ Register Src="~/MyULinkButton.ascx" TagPrefix="uc1" TagName="MyULinkButton" %>
<%@ Register Src="~/MySLinkButton.ascx" TagPrefix="uc1" TagName="MySLinkButton" %>

<%@ Register src="ActionCard.ascx" tagname="ActionCard" tagprefix="uc2" %>
...
<body>
    ...
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <ul class="nav nav-pills">
          <li class="nav-item">
              <asp:LinkButton ID="linklblInicio" runat="server" class="nav-link active" Visible="False" CommandName="Inicio" OnClick="linklblInicio_Click" >Inicio</asp:LinkButton>
          </li>
         <li class="nav-item">
    ...
    <asp:ScriptManager runat="server" ID="SM1"/>
        <p>
            &nbsp;</p>
        <div style="float:left; clear:none; margin-left:10px; margin-right:15px; margin-top: 15px; display: inline-block;">
            <asp:Panel runat="server" Width="863px" Height="500px" style="float:left;">
