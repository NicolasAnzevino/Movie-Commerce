...
{
    public partial class FormVerCarrito : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            BLL_Usuario = new BLL_Usuario();
            BLL_Venta = new BLL_Venta();
        ...
        {
            if (BLL_Venta.Obtener_Cant_Peliculas_Carrito(U) != 0)
            {
                BLL_Venta.Realizar_Compra(U);
