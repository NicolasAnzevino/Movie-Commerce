<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormVerPelicula.aspx.cs" Inherits="Movie_Commerce.FormVerPelicula" %>
...
<div class="form-control" style="width:427px; margin-left:485px;">
                    ...
                    <asp:UpdatePanel runat="server">
                        ...
                        <hr />
                        <asp:Button ID="btnAgregarAlCarrito" CssClass="btn form-control-sm btn-warning" runat="server" Text="Agregar al Carrito" style="width: 90%; height: 80%; margin-left:22px;" OnClick="btnRegresar_Click"/>
                        <br />
                        <br />
                    <div class="row">
