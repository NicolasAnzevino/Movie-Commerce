...
{
    public partial class FormGestionPeliculas : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //gvPeliculas.DataSource = BLL_Usuario.Ver_Usuarios_Vendedores_Vista();
        ...
        protected void BtnAgregar_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("FormABMPelicula.aspx", false);
        }
